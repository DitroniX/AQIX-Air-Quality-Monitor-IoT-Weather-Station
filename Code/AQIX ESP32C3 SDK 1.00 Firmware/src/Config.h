...
String AppAcronym = "AQIX";                                                                                          // Default Board Base Acronym - Do Not Change
String AppName = AppAcronym + " ESP32-C3 Air Quality IoT and Weather Station Monitor";                               // Default Board Base Acronym - Do Not Change
...
const boolean mqttSCD4x_CO2 = true;                // SCD4x CO2 (AQIX Only) - PublishDomoticzNumeric
const boolean mqttSCD4x_eCO2 = false;              // SCD4x eCO2 (AQIX Only) [WIP] - PublishDomoticzNumeric
const boolean mqttSCD4x_Humidity = true;           // SCD4x Humidity (AQIX Only) - PublishDomoticzNumeric
const boolean mqttSCD4x_Temperature = true;        // SCD4x Temperature (AQIX Only)
const boolean mqttSCD4x_TemperatureOffset = false; // SCD4x Temperature Offset (AQIX Only)
const boolean mqttSCD4x_DewPoint = true;           // SCD4x Calculated Dewpoint (AQIX Only)
